...
unittest {
	UNIT("find()", () {
		assert(find(`123456789"123456789"123456789`, '1') == 0);
		assert(find(`123456789"123456789"123456789`, '4') == 3);
		assert(find(`123456789"123456789"123456789`, '9') == 8);
		assert(find(`123456789"123456789"123456789`, '1', 1) == 10);
		assert(find(`123456789"123456789"123456789`, '4', 4) == 13);
		assert(find(`123456789"123456789"123456789`, '9', 9) == 18);
		assert(find(`123456789"123456789"123456789`, '1', 11) == 20);
		assert(find(`123456789"123456789"123456789`, '4', 14) == 23);
		assert(find(`123456789"123456789"123456789`, '9', 19) == 28);
		assert(find(`123456789"123456789"123456789`, '9', 29) == -1);
		assert(find(`123456789"123456789"123456789`, '1', -1) == -1);
		assert(find(`123456789"123456789"123456789`, '1', -10) == -1);
	});
}

unittest {
	UNIT("find()", () {
		assert(find(`123456789"123456789"123456789`, "123") == 0);
		assert(find(`123456789"123456789"123456789`, "456") == 3);
		assert(find(`123456789"123456789"123456789`, "789") == 6);
		assert(find(`123456789"123456789"123456789`, "9\"1") == 8);
		assert(find(`123456789"123456789"123456789`, "123", 1) == 10);
		assert(find(`123456789"123456789"123456789`, "456", 4) == 13);
		assert(find(`123456789"123456789"123456789`, "789", 9) == 16);
		assert(find(`123456789"123456789"123456789`, "123", 11) == 20);
		assert(find(`123456789"123456789"123456789`, "456", 14) == 23);
		assert(find(`123456789"123456789"123456789`, "789", 19) == 26);
		assert(find(`123456789"123456789"123456789`, "789", 29) == -1);
		assert(find(`123456789"123456789"123456789`, "789", 27) == -1);
		assert(find(`123456789"123456789"123456789`, "123", -1) == -1);
		assert(find(`123456789"123456789"123456789`, "123", -10) == -1);
	});
}

unittest {
	UNIT("find_r()", () {
		assert(find_r(`123456789"123456789"123456789`, '1') == 20);
		assert(find_r(`123456789"123456789"123456789`, '4') == 23);
		assert(find_r(`123456789"123456789"123456789`, '9') == 28);
		assert(find_r(`123456789"123456789"123456789`, '1', 19) == 10);
		assert(find_r(`123456789"123456789"123456789`, '4', 19) == 13);
		assert(find_r(`123456789"123456789"123456789`, '9', 19) == 18);
		assert(find_r(`123456789"123456789"123456789`, '1', 9) == 0);
		assert(find_r(`123456789"123456789"123456789`, '4', 9) == 3);
		assert(find_r(`123456789"123456789"123456789`, '9', 9) == 8);
		assert(find_r(`123456789"123456789"123456789`, '9', 29) == 28);
		assert(find_r(`123456789"123456789"123456789`, '1', -1) == -1);
		//assert(find_r(`123456789"123456789"123456789`, '1', -10) == -1);
	});
}

unittest {
	UNIT("find_r()", () {
		assert(find_r(`123456789"123456789"123456789`, "123") == 20);
		assert(find_r(`123456789"123456789"123456789`, "456") == 23);
		assert(find_r(`123456789"123456789"123456789`, "789") == 26);
		assert(find_r(`123456789"123456789"123456789`, "9\"1") == 18);
		assert(find_r(`123456789"123456789"123456789`, "123", 19) == 10);
		assert(find_r(`123456789"123456789"123456789`, "456", 19) == 13);
		assert(find_r(`123456789"123456789"123456789`, "789", 19) == 16);
		assert(find_r(`123456789"123456789"123456789`, "123", 9) == 0);
		assert(find_r(`123456789"123456789"123456789`, "456", 9) == 3);
		assert(find_r(`123456789"123456789"123456789`, "789", 9) == 6);
	});
}

unittest {
	UNIT("replace()", () {
		assert(replace(`123456789"123456789"123456789`, '1', '-') == `-23456789"-23456789"-23456789`);
		assert(replace(`123456789"123456789"123456789`, '9', '-') == `12345678-"12345678-"12345678-`);
	});
}

unittest {
	UNIT("replace()", () {
		assert(replace(`123456789"123456789"123456789`, '1', "ññ") == `ññ23456789"ññ23456789"ññ23456789`);
		assert(replace(`123456789"123456789"123456789`, '9', "ññ") == `12345678ññ"12345678ññ"12345678ññ`);
	});
}

unittest {
	UNIT("replace()", () {
		assert(replace("günther is awesome", "günther", "your mom") == "your mom is awesome");
		assert(replace("günther is awesome", "awesome", "your mom") == "günther is your mom");
	});
}

unittest {
	UNIT("replace()", () {
		assert(replace("lala", "lala", 'c') == "c");
		assert(replace("lalalala", "lala", 'c') == "cc");
		assert(replace("12lala34", "lala", 'c') == "12c34");
		assert(replace("lal;", ";}", '}') == "lal;");
		assert(replace(";}alal;;", ";}", '}') == "}alal;;");
	});
}

unittest {
	UNIT("remove()", () {
		assert(remove("123412341234", "12") == "343434");
		assert(remove("123412341234", "34") == "121212");
	});
}
