...
unittest {
	UNIT("findr()", () {
		assert(findr(`123456789"123456789"123456789`, '1') == 20);
		assert(findr(`123456789"123456789"123456789`, '4') == 23);
		assert(findr(`123456789"123456789"123456789`, '9') == 28);
		assert(findr(`123456789"123456789"123456789`, '1', 19) == 10);
		assert(findr(`123456789"123456789"123456789`, '4', 19) == 13);
		assert(findr(`123456789"123456789"123456789`, '9', 19) == 18);
		assert(findr(`123456789"123456789"123456789`, '1', 9) == 0);
		assert(findr(`123456789"123456789"123456789`, '4', 9) == 3);
		assert(findr(`123456789"123456789"123456789`, '9', 9) == 8);
		assert(findr(`123456789"123456789"123456789`, '9', 29) == 28);
		assert(findr(`123456789"123456789"123456789`, '1', -1) == -1);
		//assert(findr(`123456789"123456789"123456789`, '1', -10) == -1);
	});
}

unittest {
	UNIT("findr()", () {
		assert(findr(`123456789"123456789"123456789`, "123") == 20);
		assert(findr(`123456789"123456789"123456789`, "456") == 23);
		assert(findr(`123456789"123456789"123456789`, "789") == 26);
		assert(findr(`123456789"123456789"123456789`, "9\"1") == 18);
		assert(findr(`123456789"123456789"123456789`, "123", 19) == 10);
		assert(findr(`123456789"123456789"123456789`, "456", 19) == 13);
		assert(findr(`123456789"123456789"123456789`, "789", 19) == 16);
		assert(findr(`123456789"123456789"123456789`, "123", 9) == 0);
		assert(findr(`123456789"123456789"123456789`, "456", 9) == 3);
		assert(findr(`123456789"123456789"123456789`, "789", 9) == 6);
	});
}
